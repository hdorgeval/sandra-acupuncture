    ...
    >
      <div className="d-flex flex-column justify-content-start align-items-center">
        ...
        >
          ...
          <p>
            Le tantra s'est développé en Inde et particulièrement dans la région du Cachemire au 5me
            siècle.
          </p>
          ...
          <p>
            Autrement dit, le tantra se définit comme une voie d'expansion de la conscience et de la
          ...
          <p>
            C'est le corps qui est à l'honneur dans le tantra, il va vous permettre d'aller à votre
            propre rencontre, votre nature divine.
          </p>
          <p>
          ...
          <p>
            Se rencontrer permet de rencontrer l'autre, les autres, le monde. Le tantra vous invite
            à lâcher prise, pour être tout simplement dans l'instant présent sans jugement.
          </p>
          <p>
