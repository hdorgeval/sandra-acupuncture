        ...
        <div className="d-flex flex-column justify-content-start align-items-center">
          ...
          >
            ...
            >
              ...
              <p className="fw-bolder">
                <i className="bi bi-check-lg text-light me-1"></i>Réduction des rides et des ridules
              </p>
              ...
              <p className="fw-bolder">
                <i className="bi bi-check-lg text-light me-1"></i>Réduction des poches et des cernes
                sous les yeux
              </p>

              <p className="fw-bolder">
                <i className="bi bi-check-lg text-light me-1"></i>Relaxation et réduction du stress
                facial
              </p>
            </ReadMoreReadLess>
          </SemiTransparentTile>
