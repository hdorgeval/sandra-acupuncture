  ...
  return (
    <>
      <PublicPageLayoutWithFixedBackgroundImage
        ...
        htmlTitle={`Massage Couple | ${websiteConfig.websiteTitle}`}
      >
        <div className="d-flex flex-column justify-content-start align-items-center">
          <div className="mt-7">
            <PageTitle>Massage Couple</PageTitle>
            <OpenModalButton
          ...
          <div className="container-fluid d-flex flex-row justify-content-start align-items-stretch flex-wrap py-2 px-0">
            <div className="m-0 p-0">
              ...
              >
                ...
                >
                  <p className="">
                    Massés côte à côte, main dans la main vous vivrez un échange de grande
                    intensité.
                  </p>
                  <p>
                    À travers cette expérience partagée vous renforcerez les liens de coeur et d'âme
                    de votre couple.
                  </p>
                  <p className="">
          ...
          <RendezVousModal
            ...
            subjectOptions={[
              { label: 'Prendre un rendez vous Massage Couple' },
              { label: 'Autre' },
            ]}
...
MassageCouple.displayName = 'MassageCouple';
