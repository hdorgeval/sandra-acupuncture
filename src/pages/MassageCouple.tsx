      ...
      >
        <div className="w-100 d-flex flex-column justify-content-start align-items-center">
          ...
          >
            ...
            >
              <p className="">
                Massés côte à côte, main dans la main vous vivrez un échange de grande intensité.
              </p>
              <p>
                À travers cette expérience partagée vous renforcerez les liens de coeur et d'âme de
                votre couple.
              </p>
